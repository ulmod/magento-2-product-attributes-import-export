# Magento 2 Product Attributes Import Export Extension

[Magento 2 Product Attributes Import Export](https://www.ulmod.com/product-attributes-export-import-for-magento-2.html)  is a Magento 2 extension that allows you to easily export and import product attributes.

With Magento 2 Product Attributes Import Export, you can easily create product attributes in bulk or transfer product attributes between Magento 2 sites/installations. 

<a href="https://www.ulmod.com/product-attributes-export-import-for-magento-2.html"><img width="205" src="https://www.ulmod.com/media/wysiwyg/um-download-now1.png"></a>

## Key Features

* Export any number of product attributes into a CSV file including all data
* Ability to export product attributes per attribute sets
* Import any number of product attributes via a CSV file including all data
* Support three import behaviors: add/update, replace and delete
* Support sample import CSV file right at the import settings
* Ability to validate CSV file before any import and show the results
* Support export history, ability to manage all product attributes export log from the backend
* Ability to delete product attributes export logs/history manually or automatically


<img src="https://www.ulmod.com/media/ulmod/product_content/pattribute-export-feat.png">
<img src="https://www.ulmod.com/media/ulmod/product_content/pattribute-import-feat.png">
<img src="https://www.ulmod.com/media/ulmod/product_content/pattribute-exportlog-feat.png">
